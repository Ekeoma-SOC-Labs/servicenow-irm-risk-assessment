# ServiceNow IRM — IT Risk Assessment & Management (Home Lab Project) 📄 [Read the full IT Risk Assessment Report](phase5-documentation/IT-Risk-Assessment-Report.docx)
...
- [X] **Phase 3 — Risk Assessment:** Risk Register build-out, likelihood × impact scoring, risk-to-control linking
- [X] **Phase 4 — Treatment & Monitoring:** Remediation tasks for high-scoring risks, attestation cycle, compliance dashboard/reporting
- [X] **Phase 5 — Documentation:** Final written IT Risk Assessment Report (methodology, findings, remediation plan)
